...
public class CloudModuleVersionNotFoundException extends GameBoxCloudException {
    ...
    public CloudModuleVersionNotFoundException(String message) {
        super(message);
    }

    public CloudModuleVersionNotFoundException(String message, Throwable throwable) {
    ...
    public CloudModuleVersionNotFoundException(Throwable throwable) {
        super("The module version cannot be found in the GameBox cloud", throwable);
    }
}
