...
public class GameBoxLanguage extends Language {
  public String CMD_NO_PERM, CMD_ONLY_PLAYER, CMD_RELOADED, CMD_DISABLED_WORLD, CMD_TOKEN_INFO, CMD_TOOK_TOKEN, CMD_NOT_ENOUGH_TOKEN, CMD_GAVE_TOKEN, CMD_SET_TOKEN, RELOAD_SUCCESS, RELOAD_FAIL, CMD_OWN_TOKEN_INFO, CMD_MODULES_INVALID_SEM_VERSION, CMD_MODULES_VERSION_NOT_FOUND, CMD_CANNOT_CONNECT_TO_MODULES_CLOUD, CMD_CLOUD_MODULE_NOT_FOUND, CMD_MODULES_ALREADY_INSTALLED, CMD_MODULES_NO_UPDATE_AVAILABLE, CMD_MODULES_NOT_INSTALLED, CMD_MODULES_INSTALLING_LATEST_VERSION, CMD_MODULES_LIST_HEADER, CMD_MODULES_LIST_HEADER_SECOND, CMD_MODULES_LIST_ENTRY, CMD_MODULES_LIST_FOOTER, CMD_MODULES_REMOVE_SUCCESS, CMD_MODULES_INSTALL_SUCCESS;
  ...
  public String BUTTON_EXIT, BUTTON_TO_MAIN_MENU, BUTTON_TO_GAME_MENU, BUTTON_TOKENS, BUTTON_FORWARD, BUTTON_BACK, BUTTON_SOUND_ON_NAME, BUTTON_SOUND_OFF_NAME, BUTTON_INVITE_BUTTON_NAME, BUTTON_INVITE_SKULL_NAME, BUTTON_MODULES_GUI_NAME;
  public List<String> BUTTON_MAIN_MENU_INFO, BUTTON_SOUND_ON_LORE, BUTTON_SOUND_OFF_LORE, BUTTON_INVITE_BUTTON_LORE, BUTTON_INVITE_SKULL_LORE, BUTTON_MODULES_GUI_LORE;
