    ...
    public static NmsUtility getNmsUtility(){
        ...
        switch (VERSION) {
            case "v1_8_R1":
                ...
                return new NmsUtility_1_8_R1();
            case "v1_8_R2":
                GameBoxSettings.version1_8 = true;
                return new NmsUtility_1_8_R2();
            case "v1_8_R3":
                GameBoxSettings.version1_8 = true;
                return new NmsUtility_1_8_R3();
            case "v1_9_R1":
                return new NmsUtility_1_9_R1();
            case "v1_9_R2":
                return new NmsUtility_1_9_R2();
            case "v1_10_R1":
                return new NmsUtility_1_10_R1();
            case "v1_11_R1":
                return new NmsUtility_1_11_R1();
            case "v1_12_R1":
