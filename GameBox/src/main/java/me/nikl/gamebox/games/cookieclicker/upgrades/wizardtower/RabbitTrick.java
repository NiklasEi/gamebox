 ...
 *
 */
public class RabbitTrick extends Upgrade{

    public RabbitTrick(CookieClicker game) {
        super(game, 313);
        this.cost = 165000000000000000000000.;
        productionsRequirements.put(Buildings.WIZARD_TOWER, 250);
